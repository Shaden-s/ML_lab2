...
The Exited variable is the target variable in this dataset and it shows whether a customer has churned or not. The model will be expected to learn customer data patterns to differentiate between potential customer churners and potential customer stayers.
